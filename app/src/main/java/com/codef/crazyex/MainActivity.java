...
public class MainActivity extends AppCompatActivity  implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.button_biteyou);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_delish);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_disgust);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_donteven);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_eeeeh);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_growl);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_growlkitty);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_hey);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_noodles);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_nooo);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_punk);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_puss);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_pussyface);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_saranara);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_schmee);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_whatthecrap);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_whosthekiki);
        button.setOnClickListener(this);

        button = (Button) findViewById(R.id.button_whydyoudoit);
        button.setOnClickListener(this);
